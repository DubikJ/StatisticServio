...
import static ua.com.servio.statisticservio.common.Consts.CONNECT_SERVER_URL;
import static ua.com.servio.statisticservio.common.Consts.CONNECT_TIMEOUT_SECONDS_RETROFIT;
...
public class SyncServiceFactory {
    ...
    public static <S> S createService(Class<S> serviceClass, Context context) {
        ...
        String server = SharedStorage.getString(context, SERVER, "");
        try {
            retrofit = getBuilder(TextUtils.isEmpty(server) ? CONNECT_SERVER_URL : server)
